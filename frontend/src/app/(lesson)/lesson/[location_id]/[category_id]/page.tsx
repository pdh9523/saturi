...
export default function CategorySelectPage() {
  ...
  return (
    <Container 
      ...
      <Box sx= {{ display:"flex", justifyContent:"space-between", alignItems:"center", width:"100%", height:"560px"}}>
        {/* 맨 왼쪽 */}
        <Card sx = {{ width:"25%", height:"100%", display:"flex", justifyContent:"center", alignItems:"center", border: "1px groove", borderRadius: "8px" }}>
        ...
        {/* 중간 */}
        <Card sx = {{ width:"45%", height:"100%", display:"flex", justifyContent:"center", alignItems:"center", border: "1px groove", borderRadius: "8px" }}>
          {locationId && (
            <Puzzle
              id={locationId}
